...
name = askopenfilename(initialdir=os.getcwd(),
                       ...
                       filetypes=[('image files', ('.jpg','.png','.tif','.bmp','.tiff')),
                                  ('PDF', '.pdf')])
'''
name = "/mnt/c/Users/david/Desktop/vision/resources/Capture.PNG"
...
def detect_text(path):
    ...
    print("Writing to output.txt and drawing image...")
                ...
                for paragraph in block.paragraphs:
                    for text in paragraph.words:
                        ...
                        if (run == 0):
                            ...
                            uprint(u'{}'.format(word_text), file=open("output2.txt", "a"))
                        else:
